...
<body class="login-page">
            ...
            <div class="col-xl-5 col-lg-6 col-md-10 col-sm-12 mx-auto mt-5">
              ...
              <div class="card wow fadeIn" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="label label-danger">@include('admin.inc.errors')</div>
                <form method="post" action="{{ route('admin.dologin')}}">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn purple-gradient btn-lg">Submit</button>
                    </div>
                </form>
  ...
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="{{asset('admin/js')}}/mdb.js"></script>
